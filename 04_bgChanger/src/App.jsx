...
let a = () =>{
  ...
  <button  onClick={greenBtn} className='outline-none px-4 rounded-full text-white shadow-lg' style={{backgroundColor:'Green'}}> Green</button> 
  ...
  <button onClick={()=>("yellow")} className='outline-none px-4 rounded-full text-black shadow-lg' style={{backgroundColor:'yellow'}}> Yellow</button> 
